...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=TrYgjBaT#4pZx2I70_RYcD7yvKdOt5eZ3xyhEHlCMD6i-AXmtjNQ' : process.env.SESSION_ID,
...
ANTI_CALL: process.env.ANTI_CALL === undefined ? "" : process.env.ANTI_CALL,    
